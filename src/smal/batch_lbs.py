...
def batch_global_rigid_transformation_biggs(Rs, Js, parent, scale_factors_3x3):
    """
    Computes absolute joint locations given pose.

    Args:
      Rs: N x 35 x 3 x 3 rotation vector of K joints
      Js: N x 35 x 3, joint locations before posing
      parent: 24 holding the parent id for each index
      scale_factors_3x3: N x 35 x 3 x 3

    Returns
      new_J : `Tensor`: N x 35 x 3 location of absolute joints
      A     : `Tensor`: N x 35 4 x 4 relative joint transformations for LBS.
    """
